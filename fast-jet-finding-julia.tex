...
% Switch to the listings package as minted cannot be used currently
% with arXiv. Unfortunately attempts to define Julia as a known
% language led to errors, so we currently have no syntax highlighting
\usepackage{listings}
\usepackage{xcolor}
